...
{
    "candidates": [
        {"landmark": "장소명 또는 null", "country": "국가명 또는 null", "city": "도시명 또는 null", "confidence": 0.0},
        {"landmark": null, "country": "국가명 또는 null", "city": "도시명 또는 null", "confidence": 0.0}
    ],
    "travel_tags": ["태그1", "태그2"],
...
- 명확한 랜드마크가 보이고 위치가 확실하면 0.8 이상
- 랜드마크는 없지만 지역 특성(사투리 간판, 특징적 건물 등)이 보이면 0.5~0.7
- 랜드마크 없고 지역 단서도 없는 일반적인 풍경(카페, 해변, 산, 음식 등)은 반드시 0.3 이하
- 도시/국가를 특정할 수 없으면 city와 country를 null로 설정하고 confidence 0.1 이하
- 억지로 도시를 추측하지 말 것. 모르면 null이 정답

candidates 작성 규칙:
- 위치를 특정할 수 없으면 두 후보 모두 city: null, confidence: 0.1 이하로 작성
